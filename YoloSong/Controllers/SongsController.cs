...
namespace YoloSong.Controllers
{
    public class SongsController : Controller
    {
        ...
        {
            return View(await _context.Songs.Include(s=>s.SongCategories).ThenInclude(c=>c.Category).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create(Song song, int[] categoriesId)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Singer,Author")] Song song ,int[] categoriesId)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        var category = _context.Categories.Find(ids);
                        SongCategory songCategory = new SongCategory
                        {
                            Category = category,
                            Song = song
